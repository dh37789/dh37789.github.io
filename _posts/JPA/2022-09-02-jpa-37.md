...
![DB1]({{site.url}}/assets/image/2022/2022-09/01-jpa001.png)  ![DB2]({{site.url}}/assets/image/2022/2022-09/01-jpa002.png)

각각 test의 서버에는 TEST라는 이름의 Schema, jpa의 서버에는 JPA라는 이름의 Schema를 생성한다.

![SCHEMA1]({{site.url}}/assets/image/2022/2022-09/01-jpa005.png)  ![SCHEMA2]({{site.url}}/assets/image/2022/2022-09/01-jpa004.png)
...
![구조]({{site.url}}/assets/image/2022/2022-09/01-jpa003.png)

## 결과

실행 시킬시에 각각의 Schema에 TABLE이 생성된 것을 볼 수 있다.

![TestDB]({{site.url}}/assets/image/2022/2022-09/01-jpa006.png)

![JpaDB]({{site.url}}/assets/image/2022/2022-09/01-jpa007.png)