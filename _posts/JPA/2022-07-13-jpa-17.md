...
![상속관계]({{site.url}}/assets/image/2022-07/13-jpa001.png)
...
![조인전략]({{site.url}}/assets/image/2022-07/13-jpa002.png)
...
![조인전략2]({{site.url}}/assets/image/2022-07/13-jpa003.png)
...
![단일테이블 전략]({{site.url}}/assets/image/2022-07/13-jpa004.png)
...
![단일 테이블 전략3]({{site.url}}/assets/image/2022-07/13-jpa007.png)
...
![모든 클래스 테이블 구현 전략]({{site.url}}/assets/image/2022-07/13-jpa005.png)
...
![모든 클래스 테이블 구현 전략2]({{site.url}}/assets/image/2022-07/13-jpa006.png)
...
또한 구현클래스마다 테이블 전략은 새로운 타입이 추가될때마다 모든 클래스에 추가를 해줘야 하고, 만약 정산이라도 들어간다면 테이블마다 따로 돌려줘야하는 일이 생긴다. 따라서 실무에서 사용을 지양하는것이 좋은 전략 방법이다.
