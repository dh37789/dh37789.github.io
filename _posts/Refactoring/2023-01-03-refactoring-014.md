...
![리팩토링003]({{site.url}}/assets/image/2023/2023-01/03-refact003.png)
...
이후 하위 클래스에서는 각각 의 String타입의 type을 반환해주는 메소드로 `@Override` 해준다.
...
전체적인 코드를 확인해보자. 코드가 많이 간단해 진것을 확인 할 수 있다.
...
![리팩토링004]({{site.url}}/assets/image/2023/2023-01/03-refact004.png)
...
이때는 type에 해당하는 클래스를 새롭게 하나더 만들어줘서 각각의 type을 상속받도록 한다.
