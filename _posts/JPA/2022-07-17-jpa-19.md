...
![프록시기초1]({{site.url}}/assets/image/2022/2022-07/17-jpa001.png)
...
![프록시기초1]({{site.url}}/assets/image/2022/2022-07/17-jpa002.png)
...
![프록시특징1]({{site.url}}/assets/image/2022/2022-07/17-jpa003.png)

- 프록시 객체는 실제 객체의 참조(target)를 보관
- 프록시 객체를 호출하면 프록시 객체는 실제 객체의 메소드 호출

![프록시특징2]({{site.url}}/assets/image/2022/2022-07/17-jpa004.png)
...
![프록시특징3]({{site.url}}/assets/image/2022/2022-07/17-jpa005.png)
